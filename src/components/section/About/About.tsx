          ...
          <div data-animate="animate__fadeInRight" className="col-md-6">
            <div className={classes.text}>
              ...
              <p className={classes.paragraph}>
                ...
                or, maybe, birthday?{' '}
                <span className={classes.highlight}>Just call us</span> and
                we’ll turn all your ideas and desires into reality.
                <Image
              ...
              <p className={classes.paragraph}>
                ...
                <span className={classes.highlight}>soul</span> to every
                project.
              </p>
              <p className={classes.paragraph}>
                We have an amazing variety of ways to fill your event with{' '}
                <span className={classes.highlight}>joy</span> and make it
                special: flowers, music, photo zone - let us take care of it.
                Our experts will happily handle the{' '}
