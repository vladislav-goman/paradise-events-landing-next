          ...
          <div className="col-md-12">
            ...
            <Accordion.Root type="single" collapsible>
              ...
              >
                ...
                <Accordion.Content className={classes.content}>
                  <p>
                    ...
                    the scheduled dates. An invoice with remaining balance will
                    be emailed and must be paid in full 24 hours prior the
                    event. The event setup will not occur without full payment.
                  </p>
                </Accordion.Content>
              </Accordion.Item>
              <Accordion.Item
              ...
              >
                ...
                <Accordion.Content className={classes.content}>
                  <p>
                    In the case of rain/wet weather for picnics, the Client has
                    up to 48 hours prior to the scheduled date to decide if they
                    want to make alternate arrangements at an indoor location or
              ...
              >
                ...
                <Accordion.Content className={classes.content}>
                  <p>
                    ...
                    laws of any venue or public space being used for our pop-up
                    picnics. Public parks and beaches are prohibited from
                    drinking and a fine can be issued. We take no responsibility
                    for any alcohol consumption or penalties.
                  </p>
                </Accordion.Content>
              </Accordion.Item>
              <Accordion.Item
              ...
              >
                ...
                <Accordion.Content className={classes.content}>
                  <p>
                    We are not responsible for any food allergies or any issues
                    or illness caused from foods that were consumed or purchased
                    through us or from third party vendors.
                  </p>
                </Accordion.Content>
              </Accordion.Item>
              <Accordion.Item
              ...
              >
                ...
                <Accordion.Content className={classes.content}>
                  <p>
                    In the event that photographs of your picnic has been taken
                    by us or shared either on social media by anyone,
